    ...
    .menu-page {
        ...
        ul {
            ...
            li {
                ...
                &:nth-of-type(2) {
                    animation-name: RightToLeft_2;
                    animation-delay: .1s 
                }
                &:nth-of-type(3) {
                    animation-name: RightToLeft_3;
                    animation-delay: .1s 
                }
                &:last-of-type {
                   animation-name: RightToLeft_4;
                   animation-delay: .1s;
                }
            }
        }
